...
![image](https://github.com/user-attachments/assets/dd9e8590-d08f-4f39-8303-8c6b4b7a36c2)

Таким образом, при масштабировании до production‑нагрузки в 5 000 запросов ежемесячно критические статьи затрат — Vertex AI и Cloud Run, тогда как Firestore и мониторинг добавляют умеренные, но прогнозируемые расходы. Всё это укладывается в указанные рамки при грамотном планировании и оптимизации.
